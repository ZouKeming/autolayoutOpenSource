...
import io.github.rhino.widget.DocumentorWidget;
import io.github.rhino.widget.Widget;
import io.github.rhino.widget.WidgetFactory;

public class DocumentorWindow extends DocumentorWidget {

	public DocumentorWindow(Node node, String widgetName) {
	...
	public static void main(String[] argv) {
		...
		for(File file : files) {
			...
			if (filename.matches("GraphSchema.f[^-]*")) {
				...
				tree.load(filename);
				DocumentorWindow window = new DocumentorWindow(tree.getRoot(), "Documentor");
//				window.printr();
				System.out.printf("\n=============== Documentor Window  %s ====================\n", filename);
				// show html interface
				window.show();
	...
	private void show() {
		Widget basicWidget = WidgetFactory.create(this, "Documentor");
